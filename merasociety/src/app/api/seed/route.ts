...
const DEMO_SOCIETY_ID = '00000000-0000-0000-0000-000000000001'
  ...
  try {
    ...
    if (!supabaseUrl || supabaseUrl === 'https://placeholder.supabase.co') {
      return NextResponse.json(
        { error: 'Supabase is not configured. Set NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY in your environment.' },
        { status: 503 }
      )
    }
    ...
    // We need at least one member to be the author; use a placeholder ID
    const demoAuthorId = '00000000-0000-0000-0000-000000000301'
